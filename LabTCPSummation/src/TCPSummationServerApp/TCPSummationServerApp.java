	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				int totalMulti = numberCalculator.getMultiplication(number1, number2,number3);
				...
				System.out.println("\tTo client: Summation " + totalSum +", Multiplication "+totalMulti);
				// To client: 2101
